...
exports.getWindowSize = function(){
  if ('innerHeight' in global) {
    ...
    // In a WebController Worker, the DOM Window is not available.
    return [640, 480];
  }
};
...
// The global object is "self" in WebController Workers.
...
mocha.run = function(fn){
  ...
  return Mocha.prototype.run.call(mocha, function(){
    // The DOM Document is not available in WebController Workers.
    if (global.document) {
